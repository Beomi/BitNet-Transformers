...
# This code is baesed on Llama model from Huggingface's transformers library.
...
class LlamaForSequenceClassification(LlamaPreTrainedModel):
    def __init__(self, config):
        ...
        self.model = LlamaModel(config)
        self.score = BitLinear(config.hidden_size, self.num_labels, bias=False)
